                            ...
                            <button
                              ...
                              onClick={(e) => {
                                ...
                                openPlexWatchUrl(show || {
                                  id: show?.id,
                                  tmdbId: effectiveTmdbId,
                                  imdbId: tmdbDetails?.imdb_id || (imdbData as any)?.id || show?.imdbId,
                                  title: (title !== 'Chargement...' ? title : '') || tmdbDetails?.title || tmdbDetails?.name,
                                  originalTitle: tmdbDetails?.original_title || tmdbDetails?.original_name || show?.originalTitle,
                                  year: releaseYear,
                                  mediaType: isSeries ? 'tv' : 'movie'
                                });
                              }}
