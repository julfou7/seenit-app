...
6. Vérifier qu'aucun décalage de safe area n'apparaît au début ou à la fin du splash, dans Explorer, À Regarder et sur la navigation basse.
...
- **13/09/2026 / issue #42 / PR #311** : une preuve terrain a montré une bande sombre en haut alors que l'ancien TNR était vert. Le correctif edge-to-edge complet a été validé mais la PR a été fermée sans merge après disparition transitoire du symptôme.
- **15/09/2026 / issue #42** : une nouvelle capture terrain confirme la récidive. Le TNR précédent était donc insuffisant : l'overlay `StatusBar` ne protégeait pas contre le padding natif injecté par `SystemBars` sur Android récent. Le contrat ci-dessus devient la protection durable.
