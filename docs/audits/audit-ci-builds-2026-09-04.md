...
| [#561](https://github.com/julfou7/seenit-app/actions/runs/33853013201) | succès PR | **hit** | **ignorée** | **41 s** | cache de `main` restauré en 5 s, tous les contrôles conservés |
...
L’écriture du cache depuis `main` est prouvée par #560 et sa lecture depuis une PR par #561 :
`npm ci` est entièrement ignoré, tandis que SPEC, classification, contrat, TypeScript, tests et build
restent verts. La série de 20 validations réelles reste à collecter sans lancer de runs artificiels
uniquement pour améliorer la métrique.
