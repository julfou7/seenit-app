...
req2 = urllib.request.Request('https://api4.thetvdb.com/v4/search?query=' + urllib.parse.quote('Harry Potter') + '&type=series', headers={'Authorization': 'Bearer ' + token})
resp2 = urllib.request.urlopen(req2)
data = json.loads(resp2.read())['data']
for d in data[:5]:
    print(d['id'], d['name'], d['tvdb_id'])
