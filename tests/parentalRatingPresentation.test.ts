...
test('SEENIT-PARENTAL-001 supprime PEGI et les heuristiques parentales de genre', () => {
  ...
  assert.match(tmdbFacade, /getParentalRatingDetails\(tmdbId, mediaType\)/,
    'Explorer doit récupérer uniquement la preuve parentale au lieu de charger une fiche complète');
